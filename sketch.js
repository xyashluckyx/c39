...
boom1Img=loadAnimation("images/boom.jpg","images/boom3.png","images/boom2.png");
}
...
if(gameState===CRY){
  ...
  if(gameState===BEATING){
    textSize(30);
    fill("red");
    text("Press Space Button To Continue The Game",400,100);
  }
  if(gameState===CRY){
    text("GAMEOVER",550,300);
    textSize(30);
    fill("red");
    text("Gian beat Nobita and ran away. you can't save the Nobita.....",200,100);
